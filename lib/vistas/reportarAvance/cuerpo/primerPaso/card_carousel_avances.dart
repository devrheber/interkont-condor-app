...
class CardCarouselAvancesForm extends StatefulWidget {
  const CardCarouselAvancesForm({
    Key key,
    this.valueSaved,
    this.activity,
  }) : super(key: key);
  ...
  @override
  State<CardCarouselAvancesForm> createState() =>
      _CardCarouselAvancesFormState();
}

class _CardCarouselAvancesFormState extends State<CardCarouselAvancesForm> {
  TextEditingController controllerPrimerPasoTxtAvance;
  String valueSaved;
  ...
  double calcPorcFaltantePorEjecutar() {
    return 100.0 - activity.cantidadEjecutada;
  }
        ...
        children: <Widget>[
          ...
          Column(
            children: <Widget>[
              ...
              _Celdas(
                label: 'Avance a hoy',
                value: activity.cantidadEjecutada.toString(),
                isNumericVariable: false,
              ),
              _Celdas(
                label: 'Faltante por ejecutar',
