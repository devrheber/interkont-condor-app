...
class modalMensaje {
  static void mensaje(BuildContext context, String texto) {
                      ...
                      children: <Widget>[
                        Expanded(
                          child: RaisedButton(
                            ...
                            color: Colors.black,
                            padding: EdgeInsets.all(10.0),
                            child: Text('Aceptar', style: AppTheme.parrafo),
                            onPressed: () {
  ...
  static Future<bool> modalOpcion(
      context, String texto, Function opcion, Color colorOpcion) {
    return showDialog(
        context: context,
        barrierDismissible: true,
        builder: (BuildContext context) {
